...
<div id="app">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <img src="{{ url('/img/All-Black-Bull-Shield-LOGO-1.png') }}" alt="{{ config('app.name') }}"
                 style="height: 40px;">
        </span>
                <span class="logo-lg">
            <img src="{{ url('/img/full-black-and-white-logo.png') }}" alt="{{ config('app.name') }}"
                 style="height: 40px;">
        </span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @endif
                                <li class="footer"><a href="{{url('notifications')}}" class="bg-gray-light">View all</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{ Avatar::create(Auth::user()->firstname )->toBase64() }}"
                                     class="user-image img-bordered-sm img-circle" alt="{{ Auth::user()->firstname }}">
                                <span class="hidden-xs">{{ Auth::user()->firstname }}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="{{ url('img/All-Black-Bull-Shield-LOGO-1.png') }}" class="img-circle"
                                         alt="User Image">

                                    <p>
                                        {{ Auth::user()->firstname }} {{ Auth::user()->lastname }}
                                        <small>Member
                                            since: {{ Auth::user()->created_at->formatLocalized('%A, %d %B %Y') }}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="{{ Avatar::create(Auth::user()->firstname )->toBase64() }}"
                             class="img-bordered img-circle" alt="User Image">
                    </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ \Carbon\Carbon::now()->year  }} <a href="/">GoForex - Wealth
                    Creation.</a></strong> All rights reserved.
        </footer>
